...
> **Strategic Pivot (Feb 2026):** Clinics = first vertical for cold calls, paid traffic budget, and infrastructure. The platform adapts to demand across verticals — not exclusively healthcare. The goal is to prove the model with clinics, then expand based on market pull.
