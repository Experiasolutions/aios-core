---
description: Ativa o agente Experia Automations — Automations Builder
---

# Ativação do Agente Experia Automations

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/experia-automations.md`
