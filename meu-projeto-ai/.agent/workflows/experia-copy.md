---
description: Ativa o agente Experia Copy — Copy & Conversas
---

# Ativação do Agente Experia Copy

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/experia-copy.md`
