...
class RAGEngine {
    ...
    _detectCategory(relPath) {
        if (relPath.includes('squads/doombot')) return 'revenue';
        if (relPath.includes('squads/patient-ops')) return 'patient-ops';
        if (relPath.includes('squads/clinical')) return 'clinical';
        if (relPath.includes('squads/experia')) return 'experia';
        if (relPath.includes('squads/')) return 'squad';
