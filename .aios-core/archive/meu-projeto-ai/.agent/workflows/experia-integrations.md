---
description: Ativa o agente Experia Integrations — Engenheiro de Integrações
---

# Ativação do Agente Experia Integrations

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/experia-integrations.md`
