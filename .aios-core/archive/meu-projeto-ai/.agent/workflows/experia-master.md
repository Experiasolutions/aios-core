---
description: Ativa o agente Experia Master — Master of Clinics
---

# Ativação do Agente Experia Master

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/experia-master.md`
