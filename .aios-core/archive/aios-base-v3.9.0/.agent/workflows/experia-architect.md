---
description: Ativa o agente Experia Architect — Arquiteto de Solução
---

# Ativação do Agente Experia Architect

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/experia-architect.md`
