  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      IF iteration == max_iterations AND CRITICAL issues remain:
        - Log: "âŒ CRITICAL issues remain after 2 iterations"
...
- âŒ Starting before story is approved
- âŒ Skipping tests ("I'll add them later")
- âŒ Not updating File List in story
- âŒ Pushing directly (should use @github-devops)
- âŒ Modifying non-authorized story sections
- âŒ Forgetting to run CodeRabbit pre-commit review
